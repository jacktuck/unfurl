...
exports.schema = new Map([
    ...
    ['twitter:player:width', { entry: 'twitter_cards', name: 'width', parent: 'players', type: 'string' }],
    ['twitter:player:height', { entry: 'twitter_cards', name: 'height', parent: 'players', type: 'string' }],
    ['twitter:app:id:iphone', { entry: 'twitter_cards', name: 'id', parent: 'apps', category: 'iphone', type: 'string' }],
    ...
    ['twitter:app:id:ipad', { entry: 'twitter_cards', name: 'id', parent: 'apps', category: 'ipad', type: 'string' }],
    ...
    ['twitter:app:id:googleplay', { entry: 'twitter_cards', name: 'id', parent: 'apps', category: 'googleplay', type: 'string' }],

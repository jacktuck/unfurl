...
export const schema = new Map([
  ...
  ['article:published_time', { entry: 'article', name: 'published_time', type: 'string' }],
  ['article:modified_time', { entry: 'article', name: 'modified_time', type: 'string' }],
  ['article:expiration_time', { entry: 'article', name: 'expiration_time', type: 'string' }],
  ['article:author', { entry: 'article', name: 'author', type: 'string' }],
  ['article:section', { entry: 'article', name: 'section', type: 'string' }],
  ['article:tag', { entry: 'article', name: 'tag', type: 'string' }],

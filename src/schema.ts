...
export const schema = new Map([
  ...
  ['oEmbed:thumbnail_width', { entry: 'oEmbed', name: 'width', parent: 'thumbnail', type: 'number' }],
  ['oEmbed:thumbnail_height', { entry: 'oEmbed', name: 'height', parent: 'thumbnail', type: 'number' }],
